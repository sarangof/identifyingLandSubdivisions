...
def osmnx_command(bbox):
    ...
    try:
        ...
        #custom_filter = (
        #   '["highway"~"trunk|motorway|primary|secondary|tertiary|primary_link|secondary_link|tertiary_link|trunk_link|motorway_link|residential|unclassified|road"]'
        #   )
        
        #custom_filter = (
        #   '["highway"~"motorway|trunk|primary|secondary|tertiary|primary_link|secondary_link|tertiary_link|residential|unclassified|motorway_link|service|track|road|trunk_link"]'
        #    )

        custom_filter = (
            '["highway"~"motorway|trunk|primary|secondary|tertiary|primary_link|secondary_link|tertiary_link|residential|unclassified|motorway_link|service|track|road|trunk_link|living_street|construction|raceway|corridor|escape|bridleway|path|cycleway|footway|pedestrian"]'
            '["access"~"yes|private|permissive|destination|designated"]'
        )
        #custom_filter = (
        #    '["highway"~"motorway|trunk|primary|secondary|tertiary|primary_link|secondary_link|tertiary_link|residential|unclassified|motorway_link|service|track|road|trunk_link"]'
        #)
        #an even broader filter, supposedly.
        #'["access"~"yes|private|permissive|destination|designated"]'
        #'["vehicle"~"yes|designated|private|destination"]'
        # '["motor_vehicle"~"yes|private|destination"]'

        G = ox.graph_from_bbox(bbox=bbox, network_type="all_private") #network_type="drive_service")#network_type="drive_service") #,  tags={"highway":"trunk|motorway|primary|secondary|tertiary|primary_link|secondary_link|tertiary_link|trunk_link|motorway_link|residential|unclassified|road"}
